...
data = pd.read_csv('../../data/raw_data/nfl_elo_original.csv')
...
trimmed_data.to_csv('../../data/processed_data/nfl_historical/nfl_elo.csv', index=False)

# drop elo_prob1
trimmed_data = trimmed_data.drop(columns=['elo_prob1'], axis = 1)

trimmed_data.to_csv('../../data/processed_data/generic_nfl_data.csv', index=False)
